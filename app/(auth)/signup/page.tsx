        ...
        <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm text-zinc-500">
              Rejoignez la communauté Askelena
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                Mot de passe{" "}
                <span className="text-zinc-400 font-normal">(8 caractères min.)</span>
              </label>
              <input
                id="password"
                type="password"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {(
                  [
                    { value: "guest", label: "Réserver un lieu", emoji: "🔍" },
                    { value: "host", label: "Proposer un lieu", emoji: "🏠" },
                  ] as const
                ).map((option) => (
                  <button
                    key={option.value}
